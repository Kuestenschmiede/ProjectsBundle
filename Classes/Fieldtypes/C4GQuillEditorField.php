...
class C4GQuillEditorField extends C4GBrickField
{
    ...
    public function getC4GDialogField($fieldList, $data, C4GBrickDialogParams $dialogParams, $additionalParams = [])
    {
        ...
        $script = 'var quill = new Quill('.$id.', {theme: "snow"});';
        $fieldData = '<div onfocus="' . $script . '" id="'.$id.'" class="formdata c4geditor ui-corner-all">'.$value.'</div>';
