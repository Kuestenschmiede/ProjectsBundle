...
(function(factory){
	...
	var datepickerButton3 = [
		'<a class="datepicker-button bootstrap3 c4g__input-group-addon btn" role="button" aria-haspopup="true" tabindex="0" aria-labelledby="datepicker-bn-open-label-CALENDARID">',
	...
	var datepickerButton4 = [
		'<a class="datepicker-button c4g__btn c4g__btn-secondary c4g__input-group-append" role="button" aria-haspopup="true" tabindex="0" aria-labelledby="datepicker-bn-open-label-CALENDARID">',
		'	<span class="c4g__input-group-text"><i class="far fa-calendar-alt" title="Select Date..."></i></span>',
		'</a>'
	];
	...
	var Datepicker = function (target, options) {
		...
		if (this.$target.parent('.c4g__input-group').length == 0) {
			this.$target.wrap( '<div class="c4g__input-group c4g__input-group-date formdata"></div>' );
		}
		this.$group = this.$target.parent('.c4g__input-group');
		this.$target.attr('aria-autocomplete', 'none');
		this.$target.css('min-width', '7em');
		this.$target.addClass('c4g__form-control');
