...
$GLOBALS['TL_LANG']['FE_C4G_LIST']['SELECTGROUP']   = 'Groupselection';
$GLOBALS['TL_LANG']['FE_C4G_LIST']['SELECTPROJECT'] = 'Projectselection';
$GLOBALS['TL_LANG']['FE_C4G_LIST']['SELECTPARENT']  = '%sselection';

/** FE OPERATIONS **/
$GLOBALS['TL_LANG']['FE_C4G_LIST']['DATATABLE_CAPTION_PAGINATION']['sFirst']     = '<<';
$GLOBALS['TL_LANG']['FE_C4G_LIST']['DATATABLE_CAPTION_PAGINATION']['sLast']      = '>>';
$GLOBALS['TL_LANG']['FE_C4G_LIST']['DATATABLE_CAPTION_PAGINATION']['sPrevious']  = '<';
...
$GLOBALS['TL_LANG']['FE_C4G_LIST']['DATATABLE_CAPTION_NODESC']                   = 'No description ...';
$GLOBALS['TL_LANG']['FE_C4G_LIST']['DATATABLE_CAPTION_SEARCH']                   = 'Fastsearch';
